      ...
      <div className="min-h-screen w-2/3 mx-auto">
        ...
        {totalPages > 1 && (
            <div className="flex justify-center mt-5">
              <button
                className={`rounded border border-gray-300 text-white m-5 py-2 px-4 ${currentPage === 1 ? "opacity-50 cursor-not-allowed" : "bg-gray-500 hover:bg-gray-600"}`}
              ...
              <p className="text-white text-2xl">{`Page ${currentPage} of ${totalPages}`}</p>
              
              <button
                className={`rounded border border-gray-300 text-white m-5 py-2 px-4 ${currentPage === totalPages ? "opacity-50 cursor-not-allowed" : "bg-gray-500 hover:bg-gray-600"}`}
